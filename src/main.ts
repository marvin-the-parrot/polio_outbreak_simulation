  ...
  messages: {
    en: {
      text: {
        ...
        deathsfromvaccine: 'Polio Deaths due to Vaccine',
        costing: 'Costing:',
    ...
    de: {
      text: {
        vaccineHistory: 'Impfungen und Polio teilen sich eine lange gemeinsame Vergangenheit, wenn du mehr herausfinden willst scrolle einfach nach unten.',
        ...
        countrySelected: 'ausgewählt. Wir werden mit 1 Million Menschen simulieren.',
        ...
        oldVaccine: 'Der älteste Polio-Impfstoff (OPV) hat eine geringe Chance, eine Polio-Infektion zu verursachen. 1 von 2.700.000 Dosen hat diese Wirkung. Impfungen können Ausbrüche verursachen, verhindern aber auch die Ausbreitung von Polio.',
        ...
        paralysis: 'Lähmung',
        vaccinated: 'Geimpft',
        deathsfromvaccine: 'Polio-Todesfälle durch Impfstoff',
        costing: 'Kosten:',
